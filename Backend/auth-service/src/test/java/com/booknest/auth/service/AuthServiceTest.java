...
class AuthServiceTest {
    ...
    @Mock private BloomFilterService bloomFilterService; // Required — AuthService checks this before DB
    ...
    void setUp() {
        ...
        // Default: Bloom filter says "might exist" for all emails in tests.
        // Individual tests that need "definitely not exist" will override this.
        lenient().when(bloomFilterService.mightExist(any())).thenReturn(true);
    }
    ...
    void login_success() {
        ...
        // Mock authenticationManager to do nothing (success)
    ...
    void login_wrongPassword_throws() {
        ...
        // Mock authenticationManager to throw if password is wrong
