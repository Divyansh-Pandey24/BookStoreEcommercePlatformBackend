...
public class OrderController {
    ...
    @PostMapping("/place")
    public ResponseEntity<OrderResponse> placeOrder(@RequestHeader("X-User-Id") Long userId, @Valid @RequestBody PlaceOrderRequest request) {
    ...
    @GetMapping("/{orderId}")
    public ResponseEntity<OrderResponse> getOrderById(@PathVariable Long orderId, @RequestHeader("X-User-Id") Long userId, @RequestHeader("X-User-Role") String role) {
    ...
    public ResponseEntity<OrderResponse> cancelOrder(@PathVariable Long orderId, @RequestHeader("X-User-Id") Long userId) {
    ...
    public ResponseEntity<List<OrderResponse>> getByStatus(@PathVariable String status, @RequestHeader("X-User-Role") String role) {
    ...
    public ResponseEntity<OrderResponse> updateStatus(@PathVariable Long orderId, @RequestBody java.util.Map<String, String> body, @RequestHeader("X-User-Role") String role) {
